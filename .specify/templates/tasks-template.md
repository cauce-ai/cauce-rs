...
- [ ] TXXX Run coverage report and verify ≥95% threshold
- [ ] TXXX Add missing unit tests to reach coverage target in tests/unit/
- [ ] TXXX Verify all contract tests pass (schema compliance)
